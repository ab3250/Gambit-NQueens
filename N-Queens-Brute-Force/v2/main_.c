...
; File: "main_.c", produced by Gambit v4.9.4
(
409004
(C)
"main_"
...
___DEF_SUB_NSTR(___X0,13UL)
               ___NSTR8(99,111,108,95,114,111,119,45)
               ___NSTR5(62,99,101,108,108)
___DEF_NEW_SYM_GLO_SUP(0,___S_col__row_2d__3e_cell,___X0,430639389,___G_col__row_2d__3e_cell)
___DEF_SUB_NSTR(___X1,17UL)
               ___NSTR8(99,114,101,97,116,101,45,97)
               ___NSTR8(110,100,45,102,105,108,116,101)
               ___NSTR1(114)
___DEF_NEW_SYM_GLO_SUP(___S_col__row_2d__3e_cell,___S_create_2d_and_2d_filter,___X1,79132590,___G_create_2d_and_2d_filter)
___DEF_SUB_NSTR(___X2,7UL)
               ___NSTR7(102,108,97,116,116,101,110)
___DEF_NEW_SYM_GLO_SUP(___S_create_2d_and_2d_filter,___S_flatten,___X2,100024265,___G_flatten)
___DEF_SUB_NSTR(___X3,14UL)
               ___NSTR8(103,101,116,45,108,105,115,116)
               ___NSTR6(45,105,110,100,101,120)
___DEF_NEW_SYM_GLO_SUP(___S_flatten,___S_get_2d_list_2d_index,___X3,175602491,___G_get_2d_list_2d_index)
___DEF_SUB_NSTR(___X4,6UL)
               ___NSTR6(103,101,116,118,97,108)
___DEF_NEW_SYM_GLO_SUP(___S_get_2d_list_2d_index,___S_getval,___X4,457604046,___G_getval)
___DEF_SUB_NSTR(___X5,5UL)
               ___NSTR5(109,97,105,110,35)
___DEF_NEW_SYM_GLO_SUP(___S_getval,___S_main_23_,___X5,219417009,___G_main_23_)
___DEF_SUB_NSTR(___X6,10UL)
               ___NSTR8(109,97,107,101,45,98,111,97)
               ___NSTR2(114,100)
___DEF_NEW_SYM_GLO_SUP(___S_main_23_,___S_make_2d_board,___X6,226779646,___G_make_2d_board)
___DEF_SUB_NSTR(___X7,10UL)
               ___NSTR8(109,97,107,101,45,108,105,110)
               ___NSTR2(101,115)
___DEF_NEW_SYM_GLO_SUP(___S_make_2d_board,___S_make_2d_lines,___X7,47274381,___G_make_2d_lines)
___DEF_SUB_NSTR(___X8,12UL)
               ___NSTR8(112,101,114,109,117,116,97,116)
               ___NSTR4(105,111,110,115)
___DEF_NEW_SYM_GLO_SUP(___S_make_2d_lines,___S_permutations,___X8,309528152,___G_permutations)
___DEF_SUB_NSTR(___X9,9UL)
               ___NSTR8(112,111,115,115,105,98,108,101)
               ___NSTR1(63)
___DEF_NEW_SYM_GLO_SUP(___S_permutations,___S_possible_3f_,___X9,237918607,___G_possible_3f_)
___DEF_SUB_NSTR(___X10,7UL)
               ___NSTR7(115,101,116,118,97,108,33)
___DEF_NEW_SYM_GLO_SUP(___S_possible_3f_,___S_setval_21_,___X10,35650825,___G_setval_21_)
___DEF_SUB_NSTR(___X11,5UL)
               ___NSTR5(115,111,108,118,101)
___DEF_NEW_SYM_GLO_SUP(___S_setval_21_,___S_solve,___X11,40186928,___G_solve)
___END_NEW_SYM_GLO(___S_solve,0)
